...
void **calloc_2darray(int m, int n){
double **array;
int i;
...
//  bool MPI_ON;
  ...
  positionx = calloc_2darray(setn, SimParams.setnumb);
  positiony = calloc_2darray(setn, SimParams.setnumb);
  
  fintxarray = calloc_2darray(setn, SimParams.setnumb);
  fintyarray = calloc_2darray(setn, SimParams.setnumb);
  
  xstart = calloc_2darray(setn, SimParams.setnumb);

/*  positionx = calloc(setn, sizeof(double));
  positiony = calloc(setn, sizeof(double));
  fintxarray = calloc(setn, sizeof(double));
  fintyarray = calloc(setn, sizeof(double));
  xstart = calloc(setn, sizeof(double));
  for(i = 0; i < setn; i++){
  ...
  long int **negshift;
  long int **posshift;
  negshift = calloc(setn, sizeof(long int));
  posshift = calloc(setn, sizeof(long int));
  for(i = 0; i < setn; i++){
