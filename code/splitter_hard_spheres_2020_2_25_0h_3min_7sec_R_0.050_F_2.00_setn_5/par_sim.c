...
double readout_time;
    ...
    eq_time = (SimParams.stepnumb - SimParams.eq_stepnumb)*SimParams.time_step; 
    tot_time = (SimParams.stepnumb - SimParams.eq_stepnumb + SimParams.testab*SimParams.numbtest)*SimParams.time_step;
