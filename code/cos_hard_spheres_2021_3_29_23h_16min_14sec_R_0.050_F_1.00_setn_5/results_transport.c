/* Modul that contains functions that are needed to calculate
 * transport parameters such as histograms that reflect the 
 * particle distribution and further parameters such as the
 * non-linear mobility, moments and cumulants of the 
 * distribution
 */
 ...
 */
	...
	fprintf(outp, "\nThe total number of counted particles in histogram functions.\n"
