...
from pyx import canvas, graph, color, text
...
test_dirs = Path("../visualization_test_dirs")
histogram_file_dir = test_dirs / "histogram_test_dirs" / "test_dir_N_1_F_-10pt0" / "meanpos_Histogram2d_F_-10.000.dat"
g1.plot([
        graph.data.file(histogram_file_dir,
                        x="($1+$2)/2",
                        y="($3+$4)/2",
                        color="$5/(11000*1.0)",
                        title=None),
